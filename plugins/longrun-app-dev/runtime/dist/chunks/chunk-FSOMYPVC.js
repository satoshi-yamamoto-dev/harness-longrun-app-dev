...
// runtime/src/config/load-config.ts
...
async function loadConfig(path) {
  ...
  let input;
  try {
    input = (0, import_yaml.parse)(source, { uniqueKeys: true });
  } catch (error) {
  ...
  if (!validate(config)) {
    throw new ConfigValidationError(
      ...
      validate.errors === null || validate.errors === void 0 ? [] : [...validate.errors]
    );
  }
  return config;
}
  ...
  return {
    ...
    quality: {
      ...
      thresholds: mergeRecord(
        ...
        isRecord(input.quality) ? input.quality.thresholds : void 0
      )
    },
...
async function getConfigValidator() {
...
//# sourceMappingURL=chunk-FSOMYPVC.js.map
